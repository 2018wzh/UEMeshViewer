...
AMeshViewerGameMode::AMeshViewerGameMode()
{
    DefaultPawnClass = ASpectatorPawn::StaticClass();
    bStartPlayersAsSpectators = true;
}

void AMeshViewerGameMode::BeginPlay()
{
    Super::BeginPlay();
    ...
    AMeshActor *MeshActor = World->SpawnActor<AMeshActor>(AMeshActor::StaticClass(), FTransform::Identity, SpawnParams);
    if (!MeshActor)
    {
...
FString AMeshViewerGameMode::ResolveObjPath() const
{
...
void AMeshViewerGameMode::PositionSpectator(const FBox &Bounds) const
{
